 ...
 *
 * Derivative work: ported from AOSP SystemUI EdgePanelParams.kt
 * (Copyright (C) 2022) and android.view.animation.PathInterpolator
 * (Copyright (C) 2013), both (C) The Android Open Source Project;
